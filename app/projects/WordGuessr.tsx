...
const WordguessrDetails = () => {
  return (
    ...
    <div className="w-[50%]">
      <img src='WordGuessr_Normal.png' className='w-full h-auto rounded' alt='Twin Shooter Screen'/>
      <h1 className='text-center text-2xl mt-4'>
        WordGuessr is a Wordle-like where you guess the word in a certain number of guesses and the color of the box corresponds to where
      ...
      <div className='flex justify-between mt-5 mb-10'>
        <div className='border rounded p-2 w-[30%] text-center'>Role: Lead Back-End Developer</div>
        <div className='border rounded p-2 w-[30%] text-center'>Worked from November 2023 to December 2023</div>
        <div className='border rounded p-2 w-[30%] text-center'>Languages: Java, HTML, CSS, JavaScript, SQL</div>
      </div>
      <h2 className='text-center text-xl mb-5'>Contributions</h2>
      <div className='flex justify-between mt-5 mb-10'>
        <img src='WordGuessr_Leaderboard.png' className='w-[48%] rounded'/>
        <img src='WordGuessr_Win.png' className='w-[48%] rounded'/>
      </div>
      ...
      <p>
        I think the project went smoothly overall. We were able to begin work on the project early, where it didn't cause much stress at the end. This was due to
