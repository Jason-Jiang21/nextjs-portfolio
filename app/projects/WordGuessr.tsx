  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-[50%]">
        ...
        <div className='flex justify-between mt-5 mb-10'>
          <Image src='/WordGuessr_Leaderboard.png' className='w-[48%] rounded' alt='WordGuessr Leaderboard' width={500} height={300} />
          <Image src='/WordGuessr_Win.png' className='w-[48%] rounded' alt='WordGuessr Win' width={500} height={300} />
        </div>
