  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-[853px]">
        ...
        <div className='flex justify-between mt-5 mb-10'>
          <Image src='/SpatialStudy_Bird.png' className='w-[48%] rounded' alt='Spatial Study Bird' width={500} height={300} />
          <Image src='/SpatialStudy_Tree.png' className='w-[48%] rounded' alt='Spatial Study Tree' width={500} height={300} />
        </div>
